...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%> <%-- 제일 많이 사용하는 코드가 모여있음 --%>
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%> <%-- 문자열 관련 기능, 배열/리스트 관련 기능이 모여있음(EL 형태로 작성하는 구문) --%>
<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
...
<body>
    <h1>6. 반복문 - forEach(c:forEach 태그)</h1>
    <pre>
        - 일반 for + 추가 기능
