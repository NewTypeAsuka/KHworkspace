...
<body>
    ...
    <pre>
        ...
        1. page(pageContext): 현재 페이지, 현재 Servlet/JSP에서만 사용 가능(한 페이지)
    ...
    <ul>
        <li>
            ...
            <%
                ...
                pageContext.setAttribute("str", "page 범위의 세팅된 문자열");
            %>
        ...
        <li>
            applicationScope<br>
            applicationValue: ${applicationScope.appValue} <%-- 10000 --%>
        </li>
    </ul>
    <hr>
    <h3>우선 순위 확인</h3>
