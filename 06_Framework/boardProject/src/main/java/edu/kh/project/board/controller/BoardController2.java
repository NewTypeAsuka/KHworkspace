...
public class BoardController2 {
	...
	public String boardInsert(@PathVariable("boardCode") int boardCode) {
							// @PathVariable: 주소 값 가져오기 + requestScope에 값 올리기
	...
	public String boardInsert(
		...
		// 3. 업로드된 이미지가 서버에 실제 저장되는 경로 + 웹에서 요청 시 이미지를 볼 수 있는 경로(웹 접근 경로)
		...
		// 게시글 삽입 성공 시 -> 방금 삽입한 게시글의 상세 조회 페이지로 리다이렉트(/board/{boardCode}/{boardNo})
