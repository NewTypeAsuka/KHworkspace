...
-- user01의 비밀번호 변경
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$IWy3alGBjpJL3qZMhUOQt.EdET6F/cZ4GvcGbjHANT9lUIUdCR4lu';
...
-- BOARD_CODE가 1(공지사항)인 게시글을 최신순으로 조회(삭제된 글 제외)
SELECT * FROM "BOARD"
WHERE BOARD_CODE = 1
AND BOARD_DEL_FL = 'N'
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00001.jpg', 'cat1.jpg', 0, 1496);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00002.jpg', 'cat2.jpg', 0, 1492);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00003.jpg', 'cat3.jpg', 0, 1491);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00004.jpg', 'cat4.jpg', 0, 1484);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00005.jpg', 'cat5.jpg', 0, 1482);
...
-- 마이바티스 X
-- 1~10행만 조회
-- ROWNUM은 WHERE절에 사용될 때 1행이 조건에 포함되어야 함
SELECT * FROM (
	SELECT ROWNUM NUM, A.* FROM (
		SELECT ROWNUM,
			BOARD_NO, BOARD_TITLE, MEMBER_NICKNAME, TO_CHAR(B_CREATE_DATE, 'YYYY-MM-DD') B_CREATE_DATE, READ_COUNT
		FROM "BOARD"
		JOIN "MEMBER" USING (MEMBER_NO)
		WHERE BOARD_DEL_FL = 'N'
		AND BOARD_CODE = 1
...
INSERT INTO "BOARD_LIKE" VALUES(1496, 4);
COMMIT;

-- 특정 게시글의 좋아요 개수 카운트
SELECT COUNT(*)
FROM "BOARD_LIKE" L
WHERE L.BOARD_NO = 1496;
...
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20230508115013_00002.jpg', 'cat2.jpg', 1, 1496);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20230508115013_00003.jpg', 'cat3.jpg', 2, 1496);
...
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 1', DEFAULT, DEFAULT, 1506, 3, NULL);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2', DEFAULT, DEFAULT, 1506, 3, NULL);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1', DEFAULT, DEFAULT, 1506, 3, 1001);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-2', DEFAULT, DEFAULT, 1506, 3, 1001);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-3', DEFAULT, DEFAULT, 1506, 3, 1001);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1', DEFAULT, DEFAULT, 1506, 3, 1002);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-2', DEFAULT, DEFAULT, 1506, 3, 1002);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1-1', DEFAULT, DEFAULT, 1506, 3, 1006);
...
-- 회원 프로필 이미지 변경
UPDATE "MEMBER" SET
PROFILE_IMG = '/resources/images/member/shinchan.jpg'
WHERE MEMBER_NO = 1;
...
FROM (
	SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
			0 IMG_ORDER, 1502 BOARD_NO
	FROM DUAL
	
		UNION ALL
	
	SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
			1 IMG_ORDER, 1502 BOARD_NO
	FROM DUAL
	
		UNION ALL
	
	SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
			2 IMG_ORDER, 1502 BOARD_NO
	FROM DUAL
) A;
