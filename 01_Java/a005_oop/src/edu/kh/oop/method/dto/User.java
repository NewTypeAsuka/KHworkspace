...
public class User {
	...
	// 생성자
	public User() {} // 기본 생성자
	public User(String userId, String userPw, String userName, char userGender) { // 매개변수 생성자(오버로딩)
		this.userId = userId;
		this.userPw = userPw;
	...
	// getter/setter 작성 -> 캡슐화 원칙에 의해 직접 접근이 차단된 필드와 데이터 교환을 할 수 있는 기능(간접 접근 방법)
