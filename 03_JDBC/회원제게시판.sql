...
-- 회원(MEMBER) 테이블 만들기
CREATE TABLE "MEMBER"( -- 테이블명 만들 때는 쌍따옴표 추천
	MEMBER_NO NUMBER CONSTRAINT MEMBER_PK PRIMARY KEY, -- PK는 NOT NULL 기본 생성
...
); -- DEFAULT는 CHECK 조건 앞에 선언 필수

COMMENT ON COLUMN "MEMBER".MEMBER_NO IS '회원 번호(시퀀스 SEQ_MEMBER_NO)';
...
COMMENT ON COLUMN "BOARD"."MEMBER_NO" IS '회원 번호(FK)';

ALTER TABLE "BOARD" ADD CONSTRAINT "PK_BOARD" PRIMARY KEY (
	"BOARD_NO"
);

-- 댓글(COMMENT) 테이블 만들기(자동생성)
CREATE TABLE "COMMENT" (
	"COMMENT_NO"	NUMBER		NOT NULL,
	"COMMENT_CONTENT"	VARCHAR(2000)		NOT NULL,
	"CREATE_DT"	DATE	DEFAULT SYSDATE	NULL,
	"DELETE_FL"	CHAR(1)	DEFAULT 'N'	CHECK ("DELETE_FL" IN ('Y', 'N')),
	"NUMBER_NO"	NUMBER		NOT NULL CONSTRAINT COMMENT_MEMBER_FK REFERENCES "MEMBER"(MEMBER_NO),
...
COMMENT ON COLUMN "COMMENT"."NUMBER_NO" IS '회원 번호(FK)';
...
-- 게시글 테이블 샘플 3개 INSERT
INSERT INTO "BOARD"
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 1', '내용 1입니다\n안녕하세요', DEFAULT, DEFAULT, DEFAULT, 1);
INSERT INTO "BOARD"
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 2', '내용 2입니다\n안녕하세요', DEFAULT, DEFAULT, DEFAULT, 1);
INSERT INTO "BOARD"
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 3', '내용 3입니다\n안녕하세요', DEFAULT, DEFAULT, DEFAULT, 2);
...
-- 게시글 목록 조회
-- 게시글 번호, 제목, 작성자(이름), 작성일, 조회수를 최신 게시글 순으로 조회
SELECT BOARD_NO, BOARD_TITLE, MEMBER_NM, CREATE_DT, READ_COUNT  
FROM "BOARD"
JOIN "MEMBER" USING (MEMBER_NO)
WHERE BOARD_NO != 0 -- INDEX 사용
ORDER BY BOARD_NO DESC; -- 시퀀스라 이를 이용해서 최신 게시글 순 조회 가능

-- 댓글 테이블 샘플 3개 INSERT 
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 1입니다', DEFAULT, DEFAULT, 1, 1);
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 2입니다', DEFAULT, DEFAULT, 2, 1);
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 3입니다', DEFAULT, DEFAULT, 3, 2);
...
-- 게시글 목록 조회
-- 게시글 번호, 제목, 작성자(이름), 작성일, 조회수, 댓글 수를 최신 게시글 순으로 조회
SELECT BOARD_NO, BOARD_TITLE, MEMBER_NM, CREATE_DT, READ_COUNT, 
	(SELECT COUNT(*)
	 FROM "COMMENT" SUB
